...
<center>
![Рис. 1: Схема активного обучения (семплирование из пула)](img/al.png){#id .class width=640}
...
<center>
![Рис. 2: Задача линейного разделения. Наивный подход](img/naive.png){#id .class width=400}
...
<center>
![Рис. 3: Задача линейного разделения. Двоичный поиск](img/bs.png){#id .class width=405}
...
<center>
![Рис. 4: Пример работы обычной логистической регрессии (b) и логистической регрессии с активным обучением (с)](img/example.png){#id .class width=660}
...
<center>
![Рис. 5: Тепловые карты различных $\varphi_k(x)$ в случае трех классов. Синяя область --- наименее информативные объекты, красная область --- наиболее информативные объекты согласно данной стратегии](img/um.png){#id .class width=700}
...
<center>
![Рис. 6: Примеры пространств решений](img/vs.png){#id .class width=660}
...
<center>
![Рис. 7: Активное обучение в SVM](img/svm+al.png){#id .class width=550}
...
<center>
![Рис. 8: Simple Margin. (a) выбирается ближайшая гиперплоскость b. (b) выбирается ближайшая гиперплоскость a](img/simplemargin.png){#id .class width=550}
...
<center>
![Рис. 9: (a) MaxMin Margin --- выбирается гиперплоскость b. (b) Ratio Margin --- выбирается гиперплоскость e](img/maxminmargin.png){#id .class width=550}

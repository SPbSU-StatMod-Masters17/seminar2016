...
Полученные резульаты накладывают серьёзные ограничения на анализируемую модель (линейные зависимости, аддитивный положительный шум). На практике трудно найти такой процесс, который в самом деле подчинялся этим условиям.

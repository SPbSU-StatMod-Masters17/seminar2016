...
![Block Example 1](img/block1.png)
*Путь из $X$ в $Y$ заблокирован множеством $\{U\}$, множеством $\{Z\}$ или множеством $\{U, Z\}$.*

![Block Example 2](img/block2.png)
*Путь из $X$ в $Y$ заблокирован пустым множеством.*
...
![Factorization](img/factorize.png)
